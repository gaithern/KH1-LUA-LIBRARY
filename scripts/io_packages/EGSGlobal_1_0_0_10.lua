...
soraHP = 0x2D5D64C
soraHUD = 0x2812E9C
fnc_recalc_combo_limit_patch = 0x2A3470
fnc_recalc_combo_limit_patch_original = {0xB9, 0x07, 0x00, 0x00, 0x00, 0x88, 0x83, 0xD4, 0x00, 0x00, 0x00, 0xE8, 0xF0, 0xF5, 0xFD, 0xFF, 0x04, 0x03, 0x41, 0x8B, 0xD6}
stateFlag = 0x2867CD8
summoning = 0x2D619AC
textProg = 0x232E974
...
-- battleModeCheck
battleModeCheck = 0x1AB266

-- synthesisItemNames
UK_Word = 0x2E1B660

-- spawn_prize (kh1_native.call_function targets, matched from Steam via Ghidra
-- cross-binary fuzzy match against FUN_1402bff00/UpdateWidgetQueueValue,
...
-- 2026-07-20. NOT currently used by ko_sora -- see
-- fnc_trigger_ko_event_script below.
fnc_116_game_over = 0x1AA940

-- Trigger_ko_event_script (see SteamGlobal_1_0_0_2.lua for the full
-- writeup). Matched from Steam via Ghidra fuzzy match (score 0.5714),
-- structurally identical decompile.
