...
fnc_reverse_blob_to_slot_ptr = 0x283C30
fnc_queue_file_load_to_address = 0x289A80
fnc_blob_reloc = 0x1D5AD0
fnc_blob_fixup_a = 0x1DDF20
fnc_blob_fixup_b = 0x2B4C60
fnc_motion_fixup = 0x283F90
...
g_EVWindowState = 0x23957C4
g_EVWindowMsgCount = 0x23967D0
g_EVWindowMsgQueue = 0x23957D0
g_EVWindowMsgPosition = 0x23D4C10
g_EVWindowActivity = 0x23957C0
