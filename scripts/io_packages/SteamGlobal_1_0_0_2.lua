...
fnc_alloc_async_job_slot = 0x28A900
gimmick_job_pool = 0x2868BB0
fnc_species_model_file_loaded = 0x286290
fnc_reverse_blob_to_slot_ptr = 0x285DB0
species_owner_table = 0x2869DD0
...
fnc_queue_file_load_to_address = 0x28BC10
fnc_blob_reloc = 0x1D7C30        -- thunk_FUN_1401d7c30: primary blob relocation (model + motion)
fnc_blob_fixup_a = 0x1E0080      -- FUN_1401e0080: model section fixup (record+0x08 range)
fnc_blob_fixup_b = 0x2B6E00      -- FUN_1402b6e00: model section fixup (record+0x14 range)
fnc_motion_fixup = 0x286110      -- FUN_140286110: motion section fixup (per-entry loop)
