...
soraHP = 0x2D5CC4C
soraHUD = 0x281249C
fnc_recalc_combo_limit_patch = 0x2A5600
fnc_recalc_combo_limit_patch_original = {0xB9, 0x07, 0x00, 0x00, 0x00, 0x88, 0x83, 0xD4, 0x00, 0x00, 0x00, 0xE8, 0xD0, 0xF5, 0xFD, 0xFF, 0x04, 0x03, 0x41, 0x8B, 0xD6}
